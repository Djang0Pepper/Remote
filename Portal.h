...
const char HTML_DEVICE_MENU[] PROGMEM = "<h5><a href=\"/setup/devices\">Impostazioni Dispositivi e cléfs</a></h5>";

// Warninig message for Wifi settings
const char HTML_WIFISAVE_WARNING[] PROGMEM = "<p>La modifica a queste impostazioni provoca la temporanea disconnessione del device.<br>Se le informazioni inserite non risultano valide il device si avvierà in modalità configurazione base per consentirne la correzione</p>";
