...
#define APP_VER "0.1"
#define APP_AUTHOR "Saul Bertuccio, tracuction Fr3D"
...
const char HTML_404_TPL[] PROGMEM = "<div class=\"jumbotron\"><h1 class=\"text-warning\">Page non trouvée</h1><p><span class=\"text-muted\">Url Demandé: </span><span class=\"text-success\">{uri}</span></p><p><span class=\"text-muted\">Methode: </span><span class=\"text-success\">{method}</span></p><p><span class=\"text-muted\">Arguments: </span><span class=\"text-success\">{args}</span></p><ul>{arglist}</ul></div>";

// Body for root page
const char HTML_ROOT_TPL[] PROGMEM = "<div class=\"jumbotron col-sm-10 col-sm-offset-1\"><h1>" APP_NAME " version " APP_VER "</h1><h4>Auteur " APP_AUTHOR " " APP_RIGHT "</h4>{menu}</div>";
const char HTML_WIFI_MENU[] PROGMEM =  "<h5><a href=\"/setup/wifi\">Réglages Wi-Fi</a></h5>";
const char HTML_DEVICE_MENU[] PROGMEM = "<h5><a href=\"/setup/devices\">Réglages Device des cléfs</a></h5>";

// Warninig message for Wifi settings
const char HTML_WIFISAVE_WARNING[] PROGMEM = "<p>La modification de ces paramètres entraîne la déconnexion temporaire de l'appareil.<br>Si les informations saisies ne sont pas valides, l'appareil démarrera en mode de configuration de base pour permettre sa correction</p>";
...
// Wifi settings form
const char HTML_FULL_WIFI_FORM[] PROGMEM = "<div class=\"row\"><div class=\"col-sm-10 col-sm-offset-1\"><form name=\"wifidata\" action=\"/setup/savewifi\" method=\"POST\" class=\"form-horizontal\"><div class=\"panel panel-primary\"><div class=\"panel-heading\"><h3 class=\"panel-title\">Données réseau sans fil (Wifi)</h3>{warn}</div><div class=\"panel-body\"><div class=\"form-group col-sm-6\"><label for=\"ssid\" class=\"col-sm-3 control-label\">Nom reseau WiFi</label><div class=\"col-sm-9\"><select id=\"ssid\" name=\"ssid\" value=\"{ssid}\"><option>Attendez le chargement...</option></select><button type=\"button\" onclick=\"getNetworkList()\">Détecter</button></div></div><div class=\"form-group col-sm-6\"><label for=\"password\" class=\"col-sm-3 control-label\">Password</label><div class=\"col-sm-9\"><input type=\"password\" class=\"form-control\" id=\"password\" name=\"password\" value=\"{password}\"></div></div></div><div class=\"panel-footer clearfix\"><div class=\"pull-left\"><a href=\"/\" class=\"btn btn-primary\">Menu</a></div><div class=\"pull-right\"><button type=\"submit\" class=\"btn btn-warning\">enregistrer</button></div></div></div></form></div></div>";
const char HTML_SIMPLE_WIFI_FORM[] PROGMEM = "{warn}<style type=\"text/css\">label{width:10em;display:inline-block;}</style><form name=\"wifidata\" action=\"/setup/savewifi\" method=\"POST\"><div><h3>Dati rete Wifi</h3><label for=\"ssid\"> Nom reseau WiFi:</label><select id=\"ssid\" name=\"ssid\" value=\"{ssid}\"><option>Veuillez attendre le chargement ...</option></select><button type=\"button\" onclick=\"getNetworkList()\">Detecter</button><br/><label for=\"password\">Password:</label><input type=\"password\" id=\"password\" name=\"password\" value=\"{password}\"></div><div><button type=\"submit\">enregistrer</button></div></form><a href=\"/\">Retour au menu</a>";
...
const char JAVASCRIPT_DEVICE_ONLOAD[] PROGMEM =
  ...
  "            }), this.setCustomValidity(c ? \"Le nom de l'appareil est déjà utilisé\" : \"\")\n"
  "        }\n"
